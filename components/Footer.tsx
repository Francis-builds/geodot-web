  ...
  return (
    <footer className="bg-navy-900 text-navy-200">
      <Container className="grid gap-8 py-16 md:grid-cols-4">
        ...
        <div>
          <h3 className="mb-3 text-overline uppercase tracking-wide text-navy-300">{t("platform")}</h3>
          <Link href="/plataforma" className="block text-body-sm hover:text-teal-300">{t("allModules")}</Link>
        </div>
        <div>
          <h3 className="mb-3 text-overline uppercase tracking-wide text-navy-300">{t("company")}</h3>
        ...
        <div>
          <h3 className="mb-3 text-overline uppercase tracking-wide text-navy-300">{t("contact")}</h3>
          <Link href="/contacto" className="block text-body-sm hover:text-teal-300">{t("demo")}</Link>
        </div>
      </Container>
      <div className="border-t border-navy-800 py-6 text-center text-caption text-navy-300">{t("rights")}</div>
    </footer>
  );
}
